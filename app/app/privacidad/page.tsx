  ...
  return (
    <main className="min-h-dvh bg-[var(--bg)] text-[var(--text-primary)] [font-family:var(--font-body)] px-6 py-16 max-w-2xl mx-auto">
      ...
      <p className="text-[var(--text-secondary)] leading-relaxed mb-6">
        Fairsy es operada por Gloria Alvarado, persona natural, desde Colombia. Esta página
      ...
      <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
        Escríbannos a{' '}
        <a href="mailto:legal@fairsy.lat" className="underline">legal@fairsy.lat</a> pidiendo el
      ...
      <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
        Fairsy es para personas mayores de 18 años (la suscripción requiere un medio de pago
